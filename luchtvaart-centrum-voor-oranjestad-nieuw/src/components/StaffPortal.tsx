    ...
    <div className="space-y-6 text-slate-100 font-sans max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-wrap gap-2 border-b border-slate-800 pb-4">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg font-mono text-xs font-bold tracking-wider uppercase transition ${
            activeTab === 'issue'
        ...
        >
          <Settings size={14} /> ⚙ INSTELLINGEN & PERSONEEL ({staffMembers.length || 1})
        </button>
      </div>
        ...
        <div className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 space-y-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-slate-400 text-xs mt-0.5">Overzicht van alle burgers die geslaagd zijn en een bevoegdheid bezitten.</p>
            </div>
            ...
            <table className="w-full text-left text-xs font-mono">
              <thead>
                <tr className="text-slate-500 border-b border-slate-800/80">
                  <th className="py-3 px-3 uppercase tracking-wider">DIPLOMA ID</th>
                  <th className="py-3 px-3 uppercase tracking-wider">KLANT (PILOOT)</th>
                  <th className="py-3 px-3 uppercase tracking-wider">BURGER ID / BSN</th>
                  <th className="py-3 px-3 uppercase tracking-wider">CATEGORIE</th>
                  <th className="py-3 px-3 uppercase tracking-wider">DOCENT (STAFF)</th>
                  ...
                  return (
                    <tr key={lic.id} className="hover:bg-slate-800/30 transition">
                      ...
                      <td className="py-3.5 px-3">
                        <span className="px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-purple-900/40 text-purple-300 border border-purple-500/30">
                      ...
                      <td className="py-3.5 px-3">
                        <span className={`px-2 py-0.5 text-[10px] rounded font-bold uppercase ${
                          (lic.commissieStatus || 'VOLDAAN') === 'VOLDAAN'
                      ...
                      <td className="py-3.5 px-3">
                        <span className={`px-2 py-0.5 text-[10px] rounded font-bold uppercase ${
                          (lic.belastingStatus || 'OPENSTAAND') === 'AFGEDRAGEN'
                            ? 'bg-emerald-950/80 text-emerald-400 border border-emerald-800/80'
                            : 'bg-rose-950/80 text-rose-400 border border-rose-800/80'
                        }`}>
                          {lic.belastingStatus || 'OPENSTAAND'}
                        </span>
                      </td>
