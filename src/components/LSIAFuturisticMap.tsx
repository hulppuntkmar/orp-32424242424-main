...
export default function LSIAFuturisticMap() {
  ...
  // List of active luxury aircraft blips traveling over Oranjestad map
  const [blips, setBlips] = useState<AircraftBlip[]>([
    {
      id: "BLIP-01",
      name: "Oranjestad VIP Jet (PH-LCO)",
      type: "jet",
      status: "Rondvlucht boven Oranjestad",
      speedKmh: 450,
      altitudeFt: 4200,
      color: "#ea580c",
      x: 350,
    ...
    {
      id: "BLIP-02",
      name: "Luchtvaart Chopper (H-ORJ)",
      type: "heli",
      status: "Taxiet naar helipad",
      speedKmh: 60,
      altitudeFt: 15,
      color: "#38bdf8",
      x: 180,
    ...
    {
      id: "BLIP-03",
      name: "Cessna Skyhawk (PH-ORJ3)",
      type: "prop",
      status: "Nadering Oranjestad",
      speedKmh: 195,
      altitudeFt: 1100,
      color: "#e2e8f0",
      x: 480,
  ...
  const hotspots = [
    {
      id: "hotspot-tower",
      title: "Oranjestad Verkeerstoren",
      subtitle: "Frequentie 118.90 MHz",
      details: "Hoofdbeheercentrum. Coördineert alle starts, proefvluchten en naderingen boven Oranjestad.",
      x: 220,
      y: 190,
    },
    {
      id: "hotspot-helipads",
      title: "Oranjestad Helikopterplatform",
      subtitle: "VIP & Training Heliports",
      details: "Plaats van de direct inzetbare helikopters voor vlieglessen en VIP-vluchten.",
      x: 280,
      y: 330,
    },
    {
      id: "hotspot-runway-9",
      title: "Hoofd-landingsbaan Oranjestad",
      subtitle: "Baan 09R-27L",
      details: "De hoofd-landingsbaan voor lichte sportvliegtuigen en commerciële jets.",
      x: 420,
      y: 260,
    },
  ];
  ...
  return (
    <div className="bg-slate-950/80 border border-white/10 rounded-3xl p-6 shadow-2xl backdrop-blur-xl space-y-5 flex flex-col justify-between">
      <div>
        <div className="flex justify-between items-center border-b border-white/10 pb-4">
          <div className="flex items-center space-x-2.5">
            <Radio className="h-4.5 w-4.5 text-[#ea580c] animate-pulse" />
            <span className="font-display font-bold text-xs text-slate-100 tracking-wider font-mono uppercase">
              ORANJESTAD TACTICAL FLIGHTSPACE • ORANJESTAD RADAR
            </span>
          </div>

          <span className="flex items-center gap-1.5 bg-[#ea580c]/10 text-[#ea580c] px-3 py-1 rounded-full text-[10px] font-mono border border-[#ea580c]/20 uppercase font-bold">
            Interactive HUD ⚡
          </span>
        </div>

        {/* Map Header Instructions */}
        <p className="text-[11px] text-slate-400 mt-2.5 font-sans leading-relaxed font-light">
          Sleep de kaart om te navigeren. Klik op landingsbanen, hotspots of radar-blips voor actuele telemetrie.
        </p>
      </div>
